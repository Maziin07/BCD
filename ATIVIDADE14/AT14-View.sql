...
CREATE VIEW vw_clientes_detalhes AS
SELECT nome_cliente, email_cliente, telefone_cliente, cidade
FROM tb_cliente; 

select * from vw_clientes_detalhes;
...
FROM tb_produto GROUP BY categoria;
