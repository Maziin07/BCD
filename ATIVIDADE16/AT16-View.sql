...
SELECT MAX(Salario) AS 'Máximo Salário'
FROM funcionarios
...
SELECT AVG(Salario) AS 'Média Desenvolvedor'
FROM funcionarios
...
SELECT SUM(salario) AS 'Soma Analistas'
FROM funcionarios
...
SELECT COUNT(*) AS 'Funcionarios Curitiba - salario 3600'
FROM funcionarios
